...
file_path <- here("documents","BayacaoTransit","datasets","Las horas de laborales","Processed_Historial.xlsx")
...
df_compra <- import(here("documents","BayacaoTransit","datasets","Compra","compra_filtra.xlsx"))
df_productores <- import(here("documents","BayacaoTransit","datasets","Compra", "productores.xlsx"))

# ------------------- Décompression et Lecture du Fichier KMZ -------------------
# Décompresser et lire le fichier KMZ
kml_file <- here("documents","BayacaoTransit","doc.kml")
...
carte_Dom <- st_read(here("documents","BayacaoTransit","dom_shp", "dom_admbnda_adm1_one_20210629.shp"), options = "IGNORE_ERRORS=YES") %>%
...
carte_Dom2 <- st_read(here("documents","BayacaoTransit","dom_shp", "dom_admbnda_adm3_one_20210629.shp"), options = "IGNORE_ERRORS=YES") %>%
  st_transform(crs = 4326)  # Transformer en CRS WGS 84
